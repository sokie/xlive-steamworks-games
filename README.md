...
| Resident Evil: Operation Raccoon City | `games/orc` | `orc-gfwl` (GFWL build: SDK dll + the SDK steam_api.dll), `orc-steam` (Steam build: adds the `steam_api.dll` shim for the game's own 2012 steam_api). |
